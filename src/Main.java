...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(upString(scaner.nextLine()));
    ...
    public static boolean isLowerCase(String word){
        if(word.equals(word.toLowerCase())) {System.out.println("MOCIUM PANIE"); return true;}
        else {System.out.println("BÓJ SIE BOGA"); return false;}
    }
...
//    //zad 4-------------------------------------------------
    ...
    public static String upString(String s){
        ...
        if(!isPalindrom(supper)){
            result = "Wyraz nie jest palindromem";
        }
        else result = "Wyraz jest palindromem";
        return result;
    }
...
// TODO zad 9------------------------------------------
//    public static Integer[] isPalindromicNumber(int a, int b){
//        int lower;
//        int higher;
//        if(a < b) {
//            lower = a;
